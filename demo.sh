...
echo 'Registering AKS-AzurePolicyK8sNativeValidation feature...'
...
echo 'Creating the custom Azure Policy definition...'
...
echo 'Assigning the policy to the AKS cluster...'
...
echo 'Verifying the policy assignment...'
...
echo 'Verifying the ValidatingAdmissionPolicyBinding creation...'
...
echo 'Testing the policy by creating a privileged pod (should be denied)...'
